const { player, voice } = require("../index");
const client = require("../index");
const Str = require('@supercharge/strings');

var timeDisconnect;
function voiceDisconnect(queue) {
    timeDisconnect = setTimeout(function () { queue.destroy(disconnect = true); }, 300000)
}
...
client.player.on("error", (queue, error) => {
    ...
    //queue.metadata.send(`⚠️ | **Error!** You may need to retry that command or restart the bot using "/restart"`)
